...
import { Github, Linkedin, Mail, Phone, Copy, Check, Twitter, Instagram } from 'lucide-react'
      ...
      <div className="py-18 sm:py-20 lg:pb-40">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <img src="https://avatars.githubusercontent.com/u/92255945?v=4" className='rounded-lg' width="256" height="256"/>
            </h1>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Button asChild variant="outline" size="lg">
                <a href="https://linkedin.com/in/taylanekin" target="_blank" rel="noopener noreferrer">
                  <Linkedin className="mr-2 h-5 w-5" />
                  LinkedIn
                </a>
              </Button>
              <Button asChild variant="outline" size="lg">
                <a href="https://x.com/ekintkara" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                variant="ghost"
                onClick={() => copyToClipboard('taylanekin01@gmail.com', 'email')}
              >
